...
if tweet_input != '':
    # Pre-process tweet
    vectorizer = TfidfVectorizer(max_features=2500, min_df=.5, max_df=0.95)
    procecssed_feature_vectorized = vectorizer.fit_transform([preprocess_text(tweet_input)]).toarray()
